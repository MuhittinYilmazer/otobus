...
?>
 ...
 <div class="mb-6 border-b border-gray-200">
    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center">
        <li class="mr-2"><a href="index.php?tab=site_admins" class="inline-block p-4 border-b-2 rounded-t-lg <?php echo $tab === 'site_admins' ? 'text-blue-600 border-blue-600' : 'border-transparent hover:text-gray-600 hover:border-gray-300'; ?>">Admin Yönetimi</a></li>
